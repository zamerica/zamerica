...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("ZAmerica zamerica-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  zamerica-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zamerica transaction") + "\n" +
              "  zamerica-tx [options] -create [commands]   " + _("Create hex-encoded zamerica transaction") + "\n" +
              "\n";
