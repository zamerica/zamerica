...
int printMiningStatus(bool mining)
{
    ...
    if (mining) {
        ...
        std::cout << _("To enable mining, add 'gen=1' to your zamerica.conf and restart.") << std::endl;
        lines += 2;
    }
    std::cout << std::endl;
...
void ThreadShowMetricsScreen()
{
    ...
    RenameThread("zamerica-metrics-screen");
    ...
    // Thank you text
    std::cout << _("Thank you for running a ZAmerica node!") << std::endl;
    std::cout << _("You're helping to strengthen the America") << std::endl;
    std::cout << std::endl;
