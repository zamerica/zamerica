...
Value getnewaddress(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nReturns a new ZAmerica address for receiving payments.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. If provided, it MUST be set to the empty string \"\" to represent the default account. Passing any other string will result in an error.\n"
            "\nResult:\n"
            "\"zamericaaddress\"    (string) The new zamerica address\n"
            "\nExamples:\n"
...
Value getaccountaddress(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current ZAmerica address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) MUST be set to the empty string \"\" to represent the default account. Passing any other string will result in an error.\n"
            "\nResult:\n"
            "\"zamericaaddress\"   (string) The account zamerica address\n"
            "\nExamples:\n"
...
Value getrawchangeaddress(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new ZAmerica address, for receiving change.\n"
...
Value setaccount(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "setaccount \"zamericaaddress\" \"account\"\n"
            "\nDEPRECATED. Sets the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"zamericaaddress\"  (string, required) The zamerica address to be associated with an account.\n"
    ...
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid ZAmerica address");
...
Value getaccount(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "getaccount \"zamericaaddress\"\n"
            "\nDEPRECATED. Returns the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"zamericaaddress\"  (string, required) The zamerica address for account lookup.\n"
            "\nResult:\n"
...
Value getaddressesbyaccount(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"zamericaaddress\"  (string) a zamerica address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
Value sendtoaddress(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            "sendtoaddress \"zamericaaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount )\n"
            "\nSend an amount to a given address. The amount is a real and is rounded to the nearest 0.00000001\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"zamericaaddress\"  (string, required) The zamerica address to send to.\n"
            ...
            "                             The recipient will receive less zamerica than you enter in the amount field.\n"
            "\nResult:\n"
...
Value listaddressgroupings(const Array& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"zamericaaddress\",     (string) The zamerica address\n"
...
Value signmessage(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "signmessage \"zamericaaddress\" \"message\"\n"
            "\nSign a message with the private key of an address"
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"zamericaaddress\"  (string, required) The zamerica address to use for the private key.\n"
...
Value getreceivedbyaddress(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "getreceivedbyaddress \"zamericaaddress\" ( minconf )\n"
            "\nReturns the total amount received by the given zamericaaddress in transactions with at least minconf confirmations.\n"
            "\nArguments:\n"
            "1. \"zamericaaddress\"  (string, required) The zamerica address for transactions.\n"
...
Value sendfrom(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"tozamericaaddress\" amount ( minconf \"comment\" \"comment-to\" )\n"
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a zamerica address.\n"
            "The amount is a real and is rounded to the nearest 0.00000001."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"fromaccount\"       (string, required) MUST be set to the empty string \"\" to represent the default account. Passing any other string will result in an error.\n"
            "2. \"tozamericaaddress\"  (string, required) The zamerica address to send funds to.\n"
...
Value sendmany(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric) The zamerica address is the key, the numeric amount in btc is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less zamericas than you enter in their corresponding amount field.\n"
    ...
    BOOST_FOREACH(const Pair& s, sendTo)
    {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid ZAmerica address: ")+s.name_);
...
Value addmultisigaddress(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a ZAmerica address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keysobject\"   (string, required) A json array of zamerica addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) zamerica address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. If provided, MUST be set to the empty string \"\" to represent the default account. Passing any other string will result in an error.\n"

            "\nResult:\n"
            "\"zamericaaddress\"  (string) A zamerica address associated with the keys.\n"
...
Value listtransactions(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"zamericaaddress\",    (string) The zamerica address of the transaction. Not present for \n"
...
Value listsinceblock(const Array& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"zamericaaddress\",    (string) The zamerica address of the transaction. Not present for move transactions (category = move).\n"
...
Value gettransaction(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"zamericaaddress\",   (string) The zamerica address involved in the transaction\n"
...
Value walletpassphrase(const Array& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 2))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending zamerica\n"
            "\nArguments:\n"
...
Value encryptwallet(const Array& params, bool fHelp)
{
    ...
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending zamerica\n"
            + HelpExampleCli("walletpassphrase", "\"my pass phrase\"") +
            "\nNow we can so something like sign\n"
            + HelpExampleCli("signmessage", "\"zamericaaddress\" \"test message\"") +
    ...
    StartShutdown();
    return "wallet encrypted; ZAmerica server stopping, restart to run with encrypted wallet. The keypool has been flushed, you need to make a new backup.";
}
...
Value lockunspent(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending zamerica.\n"
...
Value getwalletinfo(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total confirmed zamerica balance of the wallet\n"
            "  \"unconfirmed_balance\": xxx, (numeric) the total unconfirmed zamerica balance of the wallet\n"
...
Value listunspent(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "3. \"addresses\"    (string) A json array of zamerica addresses to filter\n"
            "    [\n"
            "      \"address\"   (string) zamerica address\n"
            "      ,...\n"
            "    ]\n"
            "\nResult\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",  (string) the zamerica address\n"
    ...
    if (params.size() > 2) {
        ...
        BOOST_FOREACH(Value& input, inputs) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid ZAmerica address: ")+input.get_str());
            if (setAddress.count(address))
...
Value zc_sample_joinsplit(const json_spirit::Array& params, bool fHelp)
{
    ...
    JSDescription samplejoinsplit(*pzamericaParams,
                                  pubKeyHash,
                                  anchor,
                                  {JSInput(), JSInput()},
                                  {JSOutput(), JSOutput()},
...
Value zc_benchmark(const json_spirit::Array& params, bool fHelp)
{
    ...
    if (benchmarktype == "createjoinsplit") {
         ...
         * first joinsplit. */
        pzamericaParams->loadProvingKey();
    }
...
Value zc_raw_joinsplit(const json_spirit::Array& params, bool fHelp)
{
    ...
    JSDescription jsdesc(*pzamericaParams,
                         joinSplitPubKey,
                         anchor,
                         {vjsin[0], vjsin[1]},
                         {vjsout[0], vjsout[1]},
    ...
    assert(jsdesc.Verify(*pzamericaParams, joinSplitPubKey));
    ...
    std::string encryptedNote2;
    {
        ...
        ss2 << jsdesc.h_sig(*pzamericaParams, joinSplitPubKey);
...
Value z_getnewaddress(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 0)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "\nResult:\n"
            "\"zamericaaddress\"    (string) The new zaddr\n"
            "\nExamples:\n"
...
Value z_listaddresses(const Array& params, bool fHelp)
{
    ...
    Array ret;
    std::set<libzamerica::PaymentAddress> addresses;
...
Value z_listreceivedbyaddress(const Array& params, bool fHelp)
{
    ...
    libzamerica::PaymentAddress zaddr;
