...
bool CWalletDB::WriteCryptedZKey(const libzamerica::PaymentAddress & addr,
...
bool CWalletDB::WriteZKey(const libzamerica::PaymentAddress& addr, const libzamerica::SpendingKey& key, const CKeyMetadata &keyMeta)
{
    nWalletDBUpdated++;
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        {
            libzamerica::PaymentAddress addr;
            ssKey >> addr;
        ...
        else if (strType == "czkey")
        {
            ...
            uint256 vkValue;
            ssValue >> vkValue;
            libzamerica::ViewingKey vk(vkValue);
