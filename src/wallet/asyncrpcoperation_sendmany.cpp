// Copyright (c) 2016 The ZAmerica developers
...
#include "zamerica/IncrementalMerkleTree.hpp"
#include "sodium.h"
    ...
    if (z_outputs_total>0) {
        ...
        while (zOutputsDeque.size() > 0) {
            ...
            if (jsChange > 0) {
                ...
                auto hSig = prevJoinSplit.h_sig(*pzamericaParams, tx_.joinSplitPubKey);
                try {
        ...
        uint256 anchor)
{
    ...
    if (!(jsdesc.Verify(*pzamericaParams, joinSplitPubKey_))) {
    ...
    std::string encryptedNote2;
    {
        ...
        ss2 << jsdesc.h_sig(*pzamericaParams, joinSplitPubKey_);
