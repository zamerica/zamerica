...
{
public:
    libzamerica::PaymentAddress address;
    ...
    CNoteData(libzamerica::PaymentAddress a) :
            address {a}, nullifier(), witnessHeight {-1} { }
    CNoteData(libzamerica::PaymentAddress a, uint256 n) :
...
{
    JSOutPoint jsop;
    libzamerica::NotePlaintext plaintext;
};
...
public:
    ...
    std::map<libzamerica::PaymentAddress, CKeyMetadata> mapZKeyMetadata;
    ...
    bool AddZKey(const libzamerica::SpendingKey &key);
    //! Adds spending key to the store, without saving it to disk (used by LoadWallet)
    bool LoadZKey(const libzamerica::SpendingKey &key);
    //! Load spending key metadata (used by LoadWallet)
    bool LoadZKeyMetadata(const libzamerica::PaymentAddress &addr, const CKeyMetadata &meta);
    //! Adds an encrypted spending key to the store, without saving it to disk (used by LoadWallet)
    bool LoadCryptedZKey(const libzamerica::PaymentAddress &addr, const libzamerica::ViewingKey &vk, const std::vector<unsigned char> &vchCryptedSecret);
    //! Adds an encrypted spending key to the store, and saves it to disk (virtual method, declared in crypter.h)
    bool AddCryptedSpendingKey(const libzamerica::PaymentAddress &address, const libzamerica::ViewingKey &vk, const std::vector<unsigned char> &vchCryptedSecret);
