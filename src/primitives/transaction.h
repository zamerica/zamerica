...
#include "zamerica/ZAmerica.h"
#include "zamerica/JoinSplit.hpp"
#include "zamerica/Proof.hpp"
...
public:
    ...
    JSDescription(ZCJoinSplit& params,
            ...
            const uint256& rt,
            const boost::array<libzamerica::JSInput, ZC_NUM_JS_INPUTS>& inputs,
            const boost::array<libzamerica::JSOutput, ZC_NUM_JS_OUTPUTS>& outputs,
            CAmount vpub_old,
            CAmount vpub_new,
