/*
See the ZAmerica protocol specification for more information.
https://github.com/zamerica/zips/blob/master/protocol/protocol.pdf
*/
...
typedef libzamerica::NoteEncryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteEncryption;
typedef libzamerica::NoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteDecryption;
