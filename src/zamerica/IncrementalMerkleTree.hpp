...
} // end namespace `libzamerica`

typedef libzamerica::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libzamerica::SHA256Compress> ZCIncrementalMerkleTree;
typedef libzamerica::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzamerica::SHA256Compress> ZCTestingIncrementalMerkleTree;

typedef libzamerica::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libzamerica::SHA256Compress> ZCIncrementalWitness;
typedef libzamerica::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzamerica::SHA256Compress> ZCTestingIncrementalWitness;
