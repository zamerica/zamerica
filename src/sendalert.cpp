...
./zamericad -printtoconsole -sendalert
...
void ThreadSendAlert()
{
    ...
    alert.nID           = 1000;  // use https://github.com/zamerica/zamerica/wiki/specification#assigned-numbers to keep track of alert IDs
