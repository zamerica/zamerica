...
TEST(joinsplit, full_api_test)
{
    ...
    js->saveProvingKey("./zamericaTest.pk");
    js->saveVerifyingKey("./zamericaTest.vk");

    delete js;

    js = ZCJoinSplit::Unopened();

    js->setProvingKeyPath("./zamericaTest.pk");
    js->loadProvingKey();
    js->loadVerifyingKey("./zamericaTest.vk");
