...
{
    for (size_t i = 0; i < 100; i++) {
        uint252 a_sk = libzamerica::random_uint252();
        uint256 rest;
        ASSERT_TRUE(
...
TEST(noteencryption, prf_nf)
{
    for (size_t i = 0; i < 100; i++) {
        uint252 a_sk = libzamerica::random_uint252();
        uint256 rho = libzamerica::random_uint256();
        ASSERT_TRUE(
...
TEST(noteencryption, prf_pk)
{
    for (size_t i = 0; i < 100; i++) {
        uint252 a_sk = libzamerica::random_uint252();
        uint256 h_sig = libzamerica::random_uint256();
        ASSERT_TRUE(
...
{
    for (size_t i = 0; i < 100; i++) {
        uint252 phi = libzamerica::random_uint252();
        uint256 h_sig = libzamerica::random_uint256();
        ASSERT_TRUE(
