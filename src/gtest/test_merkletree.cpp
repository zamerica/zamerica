...
template<>
void expect_deser_same(const libzamerica::MerklePath& expected)
{
...
TEST(merkletree, emptyroots) {
    ...
    libzamerica::EmptyMerkleRoots<64, libzamerica::SHA256Compress> emptyroots;
