#!/bin/bash
#
# Execute all of the automated tests related to ZAmerica.
#
...
# Test phases:
run_test_phase "${REPOROOT}/qa/zamerica/check-security-hardening.sh"
run_test_phase "${REPOROOT}/qa/zamerica/ensure-no-dot-so-in-depends.py"
